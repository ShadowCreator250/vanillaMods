# example Recipe
execute as @e[name=ccl_gct,type=armor_stand,tag=old] at @s if entity @p[distance=..20] if block ~ ~1 ~ dropper{Items:[{Slot:0b,Count:1b,id:"minecraft:bedrock"},{Slot:1b,Count:1b,id:"minecraft:bedrock"},{Slot:2b,Count:1b,id:"minecraft:bedrock"},{Slot:3b,Count:1b,id:"minecraft:bedrock"},{Slot:4b,Count:1b,id:"minecraft:bedrock"},{Slot:5b,Count:1b,id:"minecraft:bedrock"},{Slot:6b,Count:1b,id:"minecraft:bedrock"},{Slot:7b,Count:1b,id:"minecraft:bedrock"},{Slot:8b,Count:1b,id:"minecraft:bedrock"}]} run tag @s add ccl_ex_r
...
# Uncraft recipe
execute as @e[name=ccl_gct,type=armor_stand,tag=old] at @s if entity @p[distance=..20] if block ~ ~1 ~ dropper{Items:[{Slot: 4b, id: "minecraft:armor_stand", Count: 1b, tag:{display:{Name:"{\"text\":\"Golden Crafting Table\",\"color\":\"gold\"}",Lore:["§bA Custom Crafting Table for your own new and customizable crafting recipes."]},EntityTag:{CustomNameVisible:0b,NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,NoBasePlate:1b,DisabledSlots:4144959,Tags:["new"],ArmorItems:[{},{},{},{id:"minecraft:light_weighted_pressure_plate",Count:1b}],CustomName:"{\"text\":\"ccl_gct\"}"}}}]} run tag @s add ccl_uncraft_r
