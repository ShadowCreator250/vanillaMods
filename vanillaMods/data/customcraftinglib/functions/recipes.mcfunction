# example Recipe
execute as @a as @e[name=ccl_gct,type=armor_stand,tag=old,distance=..20] at @s if block ~ ~1 ~ dropper{Items:[{Slot:0b,Count:1b,id:"minecraft:bedrock"},{Slot:1b,Count:1b,id:"minecraft:bedrock"},{Slot:2b,Count:1b,id:"minecraft:bedrock"},{Slot:3b,Count:1b,id:"minecraft:bedrock"},{Slot:4b,Count:1b,id:"minecraft:bedrock"},{Slot:5b,Count:1b,id:"minecraft:bedrock"},{Slot:6b,Count:1b,id:"minecraft:bedrock"},{Slot:7b,Count:1b,id:"minecraft:bedrock"},{Slot:8b,Count:1b,id:"minecraft:bedrock"}]} run tag @s add ccl_ex_r
