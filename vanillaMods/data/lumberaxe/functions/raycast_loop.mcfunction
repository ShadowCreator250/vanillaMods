...
execute as @s at @s if block ~ ~ ~ #vmcore:nonsolid run say step
execute as @s at @s unless block ~ ~ ~ #vmcore:nonsolid run say isSolid
...
execute as @s at @s if block ~ ~1 ~ #lumberaxe:logs unless block ~ ~ ~ #lumberaxe:logs if entity @e[type=item,distance=..1,tag=la_item,sort=nearest,limit=1] run say chop
execute as @s at @s align xyz positioned ~0.5 ~0.5 ~0.5 unless block ~ ~ ~ #vmcore:nonsolid run say kill
