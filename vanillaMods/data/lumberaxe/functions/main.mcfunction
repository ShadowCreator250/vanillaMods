...
tag @a[nbt={SelectedItem:{id:"minecraft:golden_axe",Count:1b,tag:{display:{Name:"{\"text\":\"LumberAxe\",\"color\":\"aqua\"}",Lore:['{"text":"This axe chops down whole trees.","color":"aqua"}']}}}},tag=!la_axe] add la_axe
