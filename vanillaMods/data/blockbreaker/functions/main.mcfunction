...
execute as @a at @s as @e[name=BlockBreaker,type=armor_stand,tag=old,tag=bb_active] at @s anchored eyes unless block ^ ^ ^1 #vmcore:noblocks run setblock ^ ^ ^1 air destroy
