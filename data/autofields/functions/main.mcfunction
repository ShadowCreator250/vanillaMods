...
execute as @a at @s as @e[type=armor_stand,tag=af_controler_t1,distance=..7,tag=old,tag=af_kill] at @s if block ~ ~ ~ #vmcore:noblocks run function autofields:gives/give_tier1
execute as @a at @s as @e[type=armor_stand,tag=af_controler_t2,distance=..7,tag=old,tag=af_kill] at @s if block ~ ~ ~ #vmcore:noblocks run function autofields:gives/give_tier2
execute as @a at @s as @e[type=armor_stand,tag=af_controler_t3,distance=..7,tag=old,tag=af_kill] at @s if block ~ ~ ~ #vmcore:noblocks run function autofields:gives/give_tier3
...
# Timer control 1 - add/remove timer tag based on fuel level
execute as @e[type=armor_stand,tag=af_controler,scores={af_fuel=1..},tag=old,tag=!vm_timer_add] at @s run tag @s add vm_timer_add
execute as @e[type=armor_stand,tag=af_controler,scores={af_fuel=0},tag=old,tag=vm_timer_add] at @s run scoreboard players set @s vm_timer 0
execute as @e[type=armor_stand,tag=af_controler,scores={af_fuel=0},tag=old,tag=vm_timer_add] at @s run tag @s remove vm_timer_add

## Runtime Actions
# particles and runtime animation
...
# every second move 1 forward
execute as @e[type=armor_stand,tag=af_controler_t1,scores={af_fuel=1..,vm_timer=20}] at @s positioned ~-5 ~-1 ~-5 as @e[type=armor_stand,limit=1,sort=nearest,tag=af_farmer_t1,dx=10,dy=3,dz=10] at @s run function autofields:t1/t1_step_control
execute as @e[type=armor_stand,tag=af_controler_t2,scores={af_fuel=1..,vm_timer=20}] at @s positioned ~-7 ~-1 ~-7 as @e[type=armor_stand,limit=1,sort=nearest,tag=af_farmer_t2,dx=14,dy=3,dz=14] at @s run function autofields:t2/t2_step_control
execute as @e[type=armor_stand,tag=af_controler_t3,scores={af_fuel=1..,vm_timer=20}] at @s positioned ~-9 ~-1 ~-9 as @e[type=armor_stand,limit=1,sort=nearest,tag=af_farmer_t3,dx=18,dy=3,dz=18] at @s run function autofields:t3/t3_step_control

execute as @e[type=armor_stand,tag=af_controler_t1,scores={af_fuel=..0,vm_timer=20}] at @s positioned ~-5 ~-1 ~-5 as @e[type=armor_stand,limit=1,sort=nearest,tag=af_farmer_t1,dx=10,dy=3,dz=10] at @s if entity @e[type=player,distance=..30] run particle crit ~ ~0.2 ~ 0.1 0.2 0.1 0.005 20
execute as @e[type=armor_stand,tag=af_controler_t2,scores={af_fuel=..0,vm_timer=20}] at @s positioned ~-7 ~-1 ~-7 as @e[type=armor_stand,limit=1,sort=nearest,tag=af_farmer_t2,dx=14,dy=3,dz=14] at @s if entity @e[type=player,distance=..30] run particle crit ~ ~0.2 ~ 0.1 0.2 0.1 0.005 20
execute as @e[type=armor_stand,tag=af_controler_t3,scores={af_fuel=..0,vm_timer=20}] at @s positioned ~-9 ~-1 ~-9 as @e[type=armor_stand,limit=1,sort=nearest,tag=af_farmer_t3,dx=18,dy=3,dz=18] at @s if entity @e[type=player,distance=..30] run particle crit ~ ~0.2 ~ 0.1 0.2 0.1 0.005 20
...
# Tier Main Control
execute if entity @e[type=armor_stand,tag=af_controler_t1] run function autofields:t1/t1_main
execute if entity @e[type=armor_stand,tag=af_controler_t2] run function autofields:t2/t2_main
execute if entity @e[type=armor_stand,tag=af_controler_t3] run function autofields:t3/t3_main

# Timer Control
scoreboard players set @e[type=armor_stand,tag=af_controler,tag=old,scores={vm_timer=20}] vm_timer 0
